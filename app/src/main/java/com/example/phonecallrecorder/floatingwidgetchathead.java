...
public class floatingwidgetchathead extends Service{
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        mFloatingWidgetView = inflater.inflate(R.layout.floating_widget_chat_head_demo, null);
    ...
    private void implementClickListeners() {
        mFloatingWidgetView.findViewById(R.id.close_floating_view).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(floatingwidgetchathead.this,"comeonnnn",Toast.LENGTH_LONG).show();
                stopSelf();
            }
        });
        mFloatingWidgetView.findViewById(R.id.close_expanded_view).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(floatingwidgetchathead.this,"collapsed",Toast.LENGTH_LONG).show();
            }
        });
        mFloatingWidgetView.findViewById(R.id.open_activity_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    //open the activity and stop service

                    Intent intent = new Intent(floatingwidgetchathead.this, input.class);
